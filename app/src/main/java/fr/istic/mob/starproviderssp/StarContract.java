...
public interface StarContract {
    ...
    interface BusRoutes {
        ...
        String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.fr.istic.starproviderSSP.busroute";
        String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.fr.istic.starproviderSSP.busroute";
    ...
    interface Trips {
        ...
        Uri CONTENT_URI = Uri.withAppendedPath(AUTHORITY_URI, CONTENT_PATH);
        String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.fr.istic.starproviderSSP.trip";
        String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.fr.istic.starproviderSSP.trip";
    ...
    interface Stops {
        ...
        Uri CONTENT_URI = Uri.withAppendedPath(AUTHORITY_URI, CONTENT_PATH);
        String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.fr.istic.starproviderSSP.stop";
        String CONTENT_ITEM_TYPE =
    ...
    interface StopTimes {
        ...
        String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.fr.istic.starproviderSSP.stoptime";
        String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.fr.istic.starproviderSSP.stoptime";
    ...
    interface Calendar {
        ...
        Uri CONTENT_URI = Uri.withAppendedPath(AUTHORITY_URI, CONTENT_PATH);
        String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.fr.istic.starproviderSSP.calendar";
        String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.fr.istic.starproviderSSP.calendar";
    ...
    interface RouteDetails {
        ...
        String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.fr.istic.starproviderSSP.routedetails";
        String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.fr.istic.starproviderSSP.routedetails";
    }
}